...
export default async (req: Request, context: Context) => {
  ...
  try {
    ...
    const baseParams = {
      ...
      ChoosePayment: "ALL",
      EncryptType: "1",
      OrderResultURL: `${siteUrl}/.netlify/functions/ecpay-post-proxy`, // Proxy function to handle ECPay POST redirect
      // Pass through customer data
      CustomField1: order.customerEmail,
      CustomField2: order.customerName,
